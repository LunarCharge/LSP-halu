...
<div class="row no-gutters mt-5">
  ...
  <div class="col-md-5 p-5 pt-5">
    <h3><i class="fas fa-book mx-2"></i>Berkas BA<hr>
     <a href="tambah_ba.php" class=" btn btn-primary mb-3"><i class="fas fa-plus-square mx-2"></i>TAMBAH DATA BERKAS</a>
...
include 'koneksi.php';
$no= 1;
$tampil = mysqli_query($koneksi, "SELECT * FROM tb_ba ");

if (isset($_GET['cari'])) {
  $tampil = mysqli_query($koneksi, "SELECT * FROM tb_ba WHERE no_surat LIKE '%". $_GET['cari']. "%'");
}
...
<tr style="text-align: center; ">
    ...
    <td>
        <a href= "edit_ba.php?no_urut='<?php echo $data['no_urut']?>'" i class="fa-solid fa-pen-to-square mx-1" style="color: green" data-toggle="tolltip" title="Edit">
      <a href="hapus_ba.php?no_urut='<?php echo $data['no_urut']?>'" i class="fa-solid fa-trash mx-1" style="color: red"></i>
<?php
}
?>
       </tbody>
